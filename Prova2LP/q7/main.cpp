...
private :
	...
	double m_salario ;
public :
	Empregado ( string nome_ , int idade_ , string matricula_ , double salario_ ) :Pessoa ( nome_ , idade_ ) , m_matricula ( matricula_ ) , m_salario ( salario_) {};
	~ Empregado () {};
...
public :
	Vendedor ( string nome_ , int idade_ , string matricula_ , double salario_ , double meta_ , double desconto_ ) :Empregado ( nome_ , idade_ , matricula_ , salario_ ) ,m_meta_mensal ( meta_ ) , m_desconto_nivel1 ( desconto_ ) {};
	~ Vendedor () {};
...
public :
	...
	void imprimeDados () 
	{cout<<" Nome : "<<m_nome <<"\t "<<" Idade " << m_idade <<"\t "<<" Matricula : "<<getMatricula()<<endl<<" Salario : "<<getSalario()<<"\t "<<" Setor : "<<m_setor <<endl<<" Desconto N2 : "<< m_desconto_nivel2<<endl;};
};
